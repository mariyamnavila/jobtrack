        ...
        <div className='container mx-auto '>
            <div className='flex justify-center items-center pt-14 pb-10'>
                <div className='lg:w-2/5 w-full px-6 space-y-5 lg:mr-36'>
                    <h2 className='text-[#1d553c] text-5xl font-bold hero-text'>The <span className='text-secondary'>Easiest Way</span> <br className='hidden lg:block'/>to Get Your New Job</h2>
